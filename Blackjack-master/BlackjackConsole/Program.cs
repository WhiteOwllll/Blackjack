...
namespace BlackjackConsole
{
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            Console.Title = "♠ Blackjack Game" + new string(' ', 11) + "...by White Owl (Shiroie@yandex.ru)";
        ...
        private static void OnLastStateChanged(object sender, EventArgs e)
        {
            ...
            Console.SetCursorPosition(Console.BufferWidth - 30, 12);
            Console.Write((game.LastState == GameState.Draw ? "NOTHING WON!" : "           ").PadLeft(28));
